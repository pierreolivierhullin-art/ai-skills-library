---
name: it-systemes
description: This skill should be used when the user asks about "IT governance", "ITIL framework", "cloud strategy", "ERP implementation", "cybersecurity governance", discusses IT service management, COBIT, or needs guidance on IT infrastructure, vendor management, or digital workplace.
version: 1.0.0
---

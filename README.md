...
Marketplace Claude Code contenant **88 skills experts** organisés en **6 domaines**, couvrant l'ensemble des disciplines business, techniques, analytiques et productivité.
...
| `code-development` | Code Development | 32 | Architecture, Code Excellence, UI/UX, Process Engineering, Auth & Security, Backend & DB, Payment/Stripe, Monitoring, DevOps, Product Analytics, Quality & Reliability, AI Engineering, API Design, Cloud Infrastructure, Mobile Development, Web Performance, Frontend Frameworks (React/Next.js), Security Testing, Web Accessibility, TypeScript Advanced, Testing Strategies (Vitest/RTL/Pact), Real-Time Systems (WebSockets/CRDT), GraphQL (Federation/DataLoader), Distributed Systems (Event Sourcing/CQRS/Saga), Caching Strategies (Redis/CDN), Developer Tooling (Turborepo/Nx), Database Advanced (Migrations/TimescaleDB), Search Engineering (pgvector/Elasticsearch/Algolia/RAG), i18n & Localization (next-intl/ICU/RTL), Email Systems (Resend/Deliverability/React Email), State Machines (XState v5/Temporal.io), UX Engineering (User Flows/Onboarding/Conversion) |

...
Marketplace Claude Code contenant **50 skills experts** organisés en **6 domaines**, couvrant l'ensemble des disciplines business, techniques, analytiques et productivité.
...
|--------|--------|--------|-------------|
| `entreprise` | Enterprise | 17 | Strategy, Marketing, Sales, Finance, PM, HR, Ops, IT, Procurement, Support, Risk, Legal, Communication, CSR/ESG, Product Strategy, User Research, Change Management |
| `code-development` | Code Development | 13 | Architecture, Code Excellence, UI/UX, Process Engineering, Auth & Security, Backend & DB, Payment/Stripe, Monitoring, DevOps, Product Analytics, Quality & Reliability, AI Engineering, API Design |
